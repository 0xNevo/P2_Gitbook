...
**Still not working?**  
→ Visit our support Telegram: [Join Community Chat](#)
...
- If status is *“pending”*, cancel and resend with a slightly higher priority.
...
**Explanation**
Funding in P² is **AI-adjusted** — not constant.  
Rates may temporarily fluctuate based on:
- Volatility
- Liquidity imbalance
- AI risk model updates

If the change is large or unexpected:
→ Check [AI Risk & Funding Page](../4_ai-engine/risk-and-funding-management.md)
...
3. Check official [Status Announcements](#) for scheduled maintenance.
...
**Quick Fix**
Always verify you’re using the **official domain**:
> ✅ `https://predictiveperpetuals.io`  

Never share private keys or seed phrases — admins will never ask for them.

If you encounter fake sites:
→ Report to [security@predictiveperpetuals.io](mailto:security@predictiveperpetuals.io)
